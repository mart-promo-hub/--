            ...
            {!isPiBrowser && (
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                <p className="text-sm text-yellow-800">
                  💡 يرجى فتح هذا التطبيق في متصفح Pi Network
                </p>
              </div>
            )}
            <button
        ...
        <header className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 mb-8">
          <div className="flex justify-between items-center">
            ...
            {user && isClient && (
              <button
                onClick={signOut}
                className="flex items-center gap-2 bg-red-50 hover:bg-red-100 px-4 py-2 rounded-full transition-colors"
              >
            ...
            <div className="text-center">
              <div className="mb-8">
                ...
                <p className="text-gray-600 mt-2">
                  قم بتسجيل الدخول باستخدام حساب Pi Network الخاص بك
                </p>
              </div>
              ...
              {!isPiBrowser && (
                <p className="text-sm text-yellow-600 mt-4 bg-yellow-50 p-3 rounded-lg">
                  💡 يرجى فتح هذا التطبيق في متصفح Pi Network
                </p>
              )}
            </div>
